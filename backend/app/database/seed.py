...
def seed_reference_wages(session: Session) -> list[ReferenceWage]:
    ...
    wages_data = [
        ...
        },
        {
            ...
            "district": "Ahmedabad",
            "sector": "Construction",
            "occupation": "Carpentry & Shuttering",
            "skill_level": "Skilled",
            "min_daily_wage": 450,
            "reference_daily_wage": 520,
            "effective_date": date(2024, 4, 1),
            "source": demo_source,
        },
        {
            ...
            "district": "Surat",
            "sector": "Textiles",
            "occupation": "Textile Weaving",
            "skill_level": "Semi-skilled",
            "min_daily_wage": 380,
            "reference_daily_wage": 420,
            "effective_date": date(2024, 4, 1),
            "source": demo_source,
        },
        {
            ...
            "district": "Surat",
            "sector": "Diamond",
            "occupation": "Diamond Cutting & Polishing",
            "skill_level": "Highly Skilled",
            "min_daily_wage": 650,
            "reference_daily_wage": 800,
            "effective_date": date(2024, 4, 1),
            "source": demo_source,
        },
        {
            ...
            "district": "Ahmedabad",
            "sector": "Electrical",
            "occupation": "Electrical Wiring",
            "skill_level": "Highly Skilled",
            "min_daily_wage": 600,
            "reference_daily_wage": 750,
            "effective_date": date(2024, 4, 1),
            "source": demo_source,
        },
        {
            ...
            "occupation": "CNC Machine Operation",
            "skill_level": "Highly Skilled",
            "min_daily_wage": 650,
            "reference_daily_wage": 780,
            "effective_date": date(2024, 4, 1),
            "source": demo_source,
        },
        {
            ...
            "district": "Surat",
            "sector": "Manufacturing",
            "occupation": "Arc & MIG Welding",
            "skill_level": "Skilled",
            "min_daily_wage": 500,
            "reference_daily_wage": 600,
            "effective_date": date(2024, 4, 1),
            "source": demo_source,
        },
        {
            ...
            "district": "Ahmedabad",
            "sector": "Transport",
            "occupation": "Heavy Vehicle Driving",
            "skill_level": "Skilled",
            "min_daily_wage": 550,
            "reference_daily_wage": 650,
            "effective_date": date(2024, 4, 1),
            "source": demo_source,
        },
        {
            ...
            "district": "Ahmedabad",
            "sector": "Construction",
            "occupation": "Construction Labor / Helper",
            "skill_level": "Unskilled",
            "min_daily_wage": 300,
            "reference_daily_wage": 350,
            "effective_date": date(2024, 4, 1),
            "source": demo_source,
        },
    ]
